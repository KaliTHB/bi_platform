  ...
  const quickActions = [
    {
      ...
      action: () => router.replace(`/workspace/${workspaceSlug}/dashboard-builder`),
    ...
    },
    {
      ...
      action: () => router.replace(`/workspace/sql-editor`),
    ...
    },
    {
      ...
      action: () => router.replace(`/workspace/${workspaceSlug}/admin/categories`),
    ...
    },
    {
      ...
      action: () => router.replace(`/workspace/${workspaceSlug}/admin`),
